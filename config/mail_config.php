...
function sendActivationEmail($email, $activation_link) {
    ...
    try {
        ...
        $mail->Password = 'wiyl rfrn frnm eije'; // App Password Gmail
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        ...
        $mail->Body = "Halo, klik link berikut untuk aktivasi akun Anda:<br><a href='$activation_link'>$activation_link</a>";
...
function sendResetPasswordEmail($email, $nama, $reset_link) {
    ...
    try {
        ...
        $mail->Body = "Halo $nama,<br> Klik link berikut untuk mereset password Anda:<br>
                       <a href='$reset_link'>$reset_link</a><br>Link berlaku 1 jam.";
